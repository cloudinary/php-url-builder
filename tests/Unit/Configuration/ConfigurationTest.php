...
class ConfigurationTest extends UnitTestCase
{
    ...
    public function testConfigToString()
    {
        ...
        $config->url->domain = 'my.domain.com';

        $config->cloud->signatureAlgorithm(Utils::ALGO_SHA256);

        self::assertStrEquals(
            $this->cloudinaryUrl . '/my.domain.com?cloud[signature_algorithm]=sha256',
            $config
        );
    }
    ...
    public function testConfigToStringWithMultipleQueryParams()
    {
        ...
        $config->url->domain = 'my.another-domain.com';

        $config->cloud->oauthToken = self::OAUTH_TOKEN;

        self::assertStrEquals(
            $this->cloudinaryUrl . '/my.another-domain.com' .
    ...
    public function testConfigKeyExplicitlySet()
    {
        ...
        self::assertTrue($config->url->analytics); // configuration default is set to true.
